    ...
    <div class=" mx-auto sm:px-6 py-4">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl font-bold">درخواست درسنامه جدید</h1>
...
<main class="max-w-5xl mx-auto  sm:px-6 ">
    ...
    <form id="lesson-plan-form"  method="POST" action="{{route('user.lessonplans.store')}}"  class="space-y-8">
    @method('POST')
        @csrf
        <!-- Basic Information -->
                    ...
                    if (data.success) {
                        ...
                        Swal.fire({
                           ...
                           // if (result.isConfirmed) {
                                location.href="/user/lessonplans";
                         //   }
                        });
