@foreach($courses as $course)
    <div
        class="course-card flex  border-2 border-gray-200 dark:border-slate-700 flex-1 w-full flex-col min-h-[560px]  group bg-white dark:bg-slate-800 rounded-2xl shadow-xl hover:shadow-2xl overflow-hidden   transition-all duration-300 hover:-translate-y-1">
        <!-- Course Image -->
        <div
        ...
        <div class="p-6 relative bg-white dark:bg-slate-800 flex-1 flex flex-col">
            ...
            <div
                class="absolute top-14 left-0 text-gray-800 border-gray-200 dark:text-white {{$course->lang == 'fa'? 'bg-amber-200 dark:bg-amber-400 ':'bg-sky-200 dark:bg-sky-500'}}     rounded-r-full px-3 py-1 shadow-[-2px_0_14px_rgba(0,0,0,0.4)] dark:shadow-black dark:shadow-[-2px_0_24px_rgba(0,0,0,0.4)] border-2 border-gray-100 border-l-0  text-lg ">
            ...
            <div class=" items-center justify-between  ">
                ...
                @else
                    ...
                    <div class=" " id="paid-course">
                        ...
                        <div class="flex items-center justify-between mb-6 border-2 border-gray-200 dark:border-gray-600 p-5 rounded-2xl">
