    ...
    <section id="homeSection" class="section">
        ...
        <div
            ...
            <div class=" mx-auto  text-center relative z-10">
                ...
                @else
                    <h1 style="font-family:'Vazirmatn-bold' !important;"
                        class=" text-4xl pt-2 text-slate-200 font-bold mb-8 bg-gradient-to-r dark:from-white dark:via-yellow-200 dark:to-pink-200  dark:text-transparent bg-clip-text  drop-shadow-[2px_2px_10px_black] dark:drop-shadow-[2px_2px_7px_violet] tv-optimized-text-shadow">
                        آموزش مفهومی فیزیک
                    </h1>
