<nav class="shadow-lg sticky text-sm top-0 z-50 bg-white dark:bg-slate-900 text-gray-900 dark:!text-white ">
                ...
                <div class="hidden md:flex flex gap-6 items-center block px-6  py-4 " x-data="{ openMenu: null }">
                    ...
                    <div class="relative">
                        <button @mouseenter="openMenu = openMenu === 'courses' ? null : 'courses'" class="flex items-center gap-1">
                            بر اساس مقطع <i class="fas fa-chevron-down text-xs mt-0.5"></i>
                        </button>
                        <div
                            ...
                            class="absolute right-0 mt-6 w-[200px]  bg-gradient-to-br from-white via-slate-50 to-slate-100 dark:from-slate-800 dark:via-slate-700 dark:to-slate-600 text-gray-800 dark:text-white rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.2)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.5)] z-50   with-blur border border-white/20 dark:border-slate-600/20"
                        >
                            <div class="flex flex-row-reverse ">


                                <!-- پایه‌ها -->
                                <div class="text-right min-w-[200px] p-2 whitespace-nowrap  border-slate-200 dark:border-slate-600  pt-3 space-y-2 text-sm ">
                    ...
                    <!-- پرسش و پاسخ‌ها -->
                    <a href="{{route('all.courses')}}" class=" hover:text-cyan-400  ">  <i class="fas fa-graduation-cap text-cyan-400"></i> دوره های آموزشی     </a>
                    <a href="{{route('files')}}" class=" hover:text-cyan-400  "> <i class="fas fa-file-archive text-green-400"></i> دانلود ها</a>
                    <a href="{{route('free.lessons')}}" class=" hover:text-cyan-400  ">  <i class="fas fa-gift text-pink-400"></i> درس های رایگان</a>
                    <a href="{{route('lesson-plan')}}" class=" hover:text-cyan-400  ">  <i class="fas fa-file-alt text-yellow-400"></i> درخواست درسنامه</a>
                    ...
                    <div class="relative">
                        ...
                        <div     x-show="openMenu === 'links'"
                            ...
                            <nav class="space-y-1">
                                ...
                                <a href="/articles" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-300 dark:hover:bg-slate-700 transition-all duration-200 group hover:-translate-x-1">
                                    <i class="fas fa-newspaper text-purple-600 group-hover:text-purple-700 dark:text-purple-400 dark:group-hover:text-purple-300 transition-colors duration-200 w-4"></i>
                                    <span class="font-medium">مقالات فیزیک بیست</span>
                                </a>
                                <a href="{{route('conversation.index')}}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-300 dark:hover:bg-slate-700 transition-all duration-200 group hover:-translate-x-1">
                                    <i class="fas fa-comment-alt text-blue-600 group-hover:text-blue-700 dark:text-blue-400 dark:group-hover:text-blue-300 transition-colors duration-200 w-4"></i>
                                    <span class="font-medium">پرسش و پاسخ</span>
                                </a>
                                ...
                                <a href="/ask" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-300 dark:hover:bg-slate-700 transition-all duration-200 group hover:-translate-x-1">
                                    <i class="fas fa-circle-question text-green-600 group-hover:text-green-700 dark:text-green-400 dark:group-hover:text-green-300 transition-colors duration-200 w-4"></i>
    ...
    <div id="mobileMenu" class="mobile-menu fixed top-0 right-0 h-full w-80 bg-white/95 dark:bg-gray-900/95 with-blur shadow-2xl z-50 md:hidden border-l border-gray-200 dark:border-gray-700">
        ...
        <div class="p-3  overflow-y-auto h-full pb-32">
            ...
            <a href="{{ route('free.lessons') }}"  class="flex items-center space-x-4 space-x-reverse  rounded-lg hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 dark:hover:from-purple-900/20 dark:hover:to-blue-900/20 text-gray-700 dark:text-gray-700 group transition-all duration-200 hover:transform hover:-translate-x-1">
                <div class="flex items-center space-x-4 space-x-reverse p-3 text-gray-800 dark:text-gray-100">
                    <div class="pr-4 rounded-lg flex items-center justify-center">
                        <i class="fas fa-gift text-pink-400 text-sm"></i>
                    </div>
                    <span class="font-semibold "> درسهای رایگان </span>
                </div>
            </a>
            <a href="{{ route('lesson-plan') }}"  class="flex items-center space-x-4 space-x-reverse  rounded-lg hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 dark:hover:from-purple-900/20 dark:hover:to-blue-900/20 text-gray-700 dark:text-gray-700 group transition-all duration-200 hover:transform hover:-translate-x-1">
                <div class="flex items-center space-x-4 space-x-reverse p-3 text-gray-800 dark:text-gray-100">
                    <div class="pr-4 rounded-lg flex items-center justify-center">
                        <i class="fas fa-file-alt text-yellow-400 text-sm"></i>
                    </div>
                    <span class="font-semibold "> درخواست درسنامه  </span>
                </div>
            </a>
