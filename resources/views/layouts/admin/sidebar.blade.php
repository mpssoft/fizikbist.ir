...
>
    ...
    <nav class="flex flex-col gap-3 px-4 text-sm md:text-base mt-4">
        <a href="{{route('admin.home')}}" class="flex items-center gap-2 px-4 py-2 rounded hover:bg-slate-200 dark:hover:bg-slate-700">
            <i class="fas fa-home"></i> صفحه اصلی
        </a>
        <a href="{{ route('admin.courses.index') }}" class="flex items-center gap-2 px-4 py-2 rounded hover:bg-slate-200 dark:hover:bg-slate-700">
