...
<div class="max-w-5xl mx-auto space-y-8">
    ...
    <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur rounded-2xl shadow-xl border border-indigo-100 dark:border-gray-700 overflow-hidden">
        <div class="p-8">
            <nav class="flex items-center text-sm text-gray-500 dark:text-gray-400 mb-6 gap-2" aria-label="Breadcrumb">
                ...
                <span class="text-gray-300">/</span>
                <span class="text-gray-700 dark:text-gray-300 font-medium">ارسال پیام به کاربران</span>
            </nav>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-indigo-100 dark:border-gray-700 overflow-hidden">
        <div class="p-8">
            <form method="POST" action="{{route('admin.messages.send')}}"  class="space-y-10">
                @csrf

                <!-- Audience -->
                <section class="space-y-6">
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-white">انتخاب مخاطب</h2>
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                        ...
                        {{--<div class="md:col-span-5">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                --}}{{--<div>
                                    <label for="role" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">ارسال به نقش</label>
                               ...
                               --}}{{--<div>
                                     <label for="audience" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">گستره</label>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">ترکیب‌ها پشتیبانی می‌شوند: مثلاً «دانشجو» + «فعال».</p>
                        </div>--}}
                    </div>
                </section>
                ...
                <!-- Meta -->
                <section class="space-y-6">
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-white">مشخصات پیام</h2>
